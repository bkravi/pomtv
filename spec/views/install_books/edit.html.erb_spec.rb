...
describe "install_books/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit install_book form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => install_books_path(@install_book), :method => "post" do
