...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :cust_infs, 'Customer Details', cust_infs_path, :highlights_on => /\/cust_infs/
    primary.item :install_books, 'Customer Bookings', install_books_path, :highlights_on => /\/install_books/
    primary.item :utilities, 'Reports', utilities_path, :highlights_on => /\/utilities/
